...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/rcfm2/maddenall32/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
  
  else if(request.text && botRegexOW.test(request.text)) {
    this.res.writeHead(200);
    postMessage("www.daddyleagues.com/rcfm2/maddenrating/");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/rcfm2/maddenall32/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/rcfm2/maddenall32/players?name="+rep+"&position=all&team=all");
